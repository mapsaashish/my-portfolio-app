            ...
            sampleWorks: [
                {
                    ...
                    fullDescription: 'The Community GIS Tool (CGIST) is a groundbreaking system developed to empower the Nepal Police in strengthening their problem-solving capabilities. My role involved overseeing its development and implementation, ensuring it met operational needs. I also conducted extensive training sessions for Nepal Police officials, psychosocial workers, and SARA Social Mobilizers, enabling them to effectively utilize CGIST for data collection and analysis in the field. This tool has significantly improved evidence-based problem-solving in security and justice programs across Nepal. It integrates spatial data with real-time incident reporting, providing a comprehensive overview for strategic decision-making and resource allocation. This project highlights my ability to manage complex geospatial projects from conception to deployment, including user training and ongoing support. The impact of CGIST has been profound, leading to more efficient response times and better-informed community policing initiatives.',
                    additionalImages: [
